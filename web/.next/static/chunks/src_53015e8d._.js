...
function CartPage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [selectedProvince, setSelectedProvince] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [selectedDistrict, setSelectedDistrict] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const [recipientPhone, setRecipientPhone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const fetchCart = async ()=>{
        try {
            ...
            if (response.ok) {
                ...
                setCartItems(((_data_data = data.data) === null || _data_data === void 0 ? void 0 : _data_data.items) || []);
            }
        } catch (error) {
    ...
    const fetchDistricts = async (provinceId)=>{
        try {
            const response = await fetch("http://localhost:4000/api/shipping/districts/".concat(provinceId));
            if (response.ok) {
                const data = await response.json();
    ...
    const fetchWards = async (districtId)=>{
        try {
            const response = await fetch("http://localhost:4000/api/shipping/wards/".concat(districtId));
            if (response.ok) {
                const data = await response.json();
                setWards(data.data || []);
            }
    ...
    const updateQuantity = async (itemId, newQuantity)=>{
        ...
        try {
            ...
            const response = await fetch('http://localhost:4000/api/cart', {
                ...
                body: JSON.stringify({
                    product_id: (_cartItems_find = cartItems.find((item)=>item.id === itemId)) === null || _cartItems_find === void 0 ? void 0 : _cartItems_find.product_id,
    ...
    const removeItem = async (productId)=>{
        try {
            const token = localStorage.getItem('accessToken');
            const response = await fetch("http://localhost:4000/api/cart/".concat(productId), {
                method: 'DELETE',
                headers: {
                    'Authorization': "Bearer ".concat(token)
                }
    ...
    const total = subtotal + ((shippingFee === null || shippingFee === void 0 ? void 0 : shippingFee.total) || 0);
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                children: calculatingFee ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-sm",
                                                                    children: "Đang tính..."
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/cart/page.tsx",
...
//# sourceMappingURL=src_53015e8d._.js.map