...
"[project]/web/src/lib/api-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const API_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:4000/api';
class ApiClient {
    getAuthToken() {
    ...
    constructor(baseUrl){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "baseUrl", void 0);
...
"[project]/web/src/hooks/useAuth.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider(param) {
        ...
        "AuthProvider.useEffect": ()=>{
            async function loadUser() {
                try {
                    ...
                    if (token) {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getMe();
                        if (response.success) {
    ...
    const login = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].login({
                email,
                password
            });
            if (response.success) {
    ...
    const register = async (fullName, email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].register({
                full_name: fullName,
                email,
                password
            });
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].logout();
        } catch (error) {
...
//# sourceMappingURL=web_src_6845dae6._.js.map