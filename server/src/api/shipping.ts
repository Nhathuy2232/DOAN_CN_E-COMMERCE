...
router.get('/provinces', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getProvinceAsync();
    if (result.success) {
      res.json(result);
    } else {
...
router.get('/districts/:provinceId', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getDistrictAsync({ provinceId });
    if (result.success) {
      res.json(result);
    } else {
      console.warn('GHN API failed, using mock data');
...
router.get('/wards/:districtId', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getWardAsync({ districtId });
    if (result.success) {
      res.json(result);
    } else {
      console.warn('GHN API failed, using mock data');
...
router.post('/available-services', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getServiceAsync({ fromDistrict: from_district, toDistrict: to_district });
    if (result.success) {
      res.json(result);
    } else {
...
router.post('/leadtime', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getLeadTimeAsync({
      fromDistrictId,
      fromWardCode,
      toDistrictId,
      toWardCode,
...
router.post('/create-order', async (req, res, next) => {
  try {
    const result = await ghnService.createOrderAsync(req.body);
    if (result.success) {
      res.json(result);
    } else {
      res.status(500).json(result);
...
router.get('/order/:orderCode', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getOrderInfoAsync({ orderCode });
    if (result.success) {
      res.json(result);
    } else {
      res.status(500).json(result);
...
router.post('/cancel-order', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.cancelOrder({ orderCodes: order_codes });
    if (result.success) {
      res.json(result);
    } else {
      res.status(500).json(result);
...
router.post('/update-cod', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.updateCODAsync({
...
router.post('/preview-order', async (req, res, next) => {
  try {
    const result = await ghnService.previewOrderAsync(req.body);
...
router.get('/pick-shift', async (req, res, next) => {
  try {
    const result = await ghnService.getPickShiftAsync();
...
router.post('/create-ticket', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.createTicketAsync({
      orderCode: order_code,
      category,
      description,
      cEmail: c_email,
...
router.post('/order-by-client-code', async (req, res, next) => {
  try {
    ...
    const result = await ghnService.getOrderByClientCodeAsync(client_order_code);
