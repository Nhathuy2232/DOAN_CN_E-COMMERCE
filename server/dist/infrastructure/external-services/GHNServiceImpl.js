...
class GHNService {
    ...
    client;
    constructor() {
        this.baseUrl = env_1.default.ghn.baseUrl;
        this.token = env_1.default.ghn.token;
        this.shopId = env_1.default.ghn.shopId;
        if (!this.token) {
     ...
     */
    async getDistrictAsync(request) {
        try {
     ...
     */
    async calculateFeeAsync(request) {
        try {
            const requestData = {
     ...
     */
    async getLeadTimeAsync(request) {
        try {
            const requestData = {
                from_district_id: request.fromDistrictId,
     ...
     */
    async getOrderInfoAsync(request) {
        try {
     ...
     */
    async updateCODAsync(request) {
        try {
            const requestData = {
                order_code: request.orderCode,
                cod_amount: request.codAmount,
            };
            const response = await this.client.post('/shiip/public-api/v2/shipping-order/updateCOD', requestData, {
                headers: this.getHeaders('order'),
            });
            return {
                success: true,
     ...
     */
    async previewOrderAsync(request) {
        try {
            const requestData = {
                payment_type_id: request.paymentTypeId,
                required_note: request.requiredNote || 'KHONGCHOXEMHANG',
            ...
            const response = await this.client.post('/shiip/public-api/v2/shipping-order/preview', requestData, {
                headers: this.getHeaders('order'),
            });
            return {
                success: true,
     ...
     */
    async createTicketAsync(request) {
        try {
            ...
            const response = await this.client.post('/shiip/public-api/ticket/create', formData, {
                headers: {
     ...
     */
    async getOrderByClientCodeAsync(clientOrderCode) {
        try {
            const requestData = {
                client_order_code: clientOrderCode,
            };
            const response = await this.client.post('/shiip/public-api/v2/shipping-order/detail-by-client-code', requestData, {
                headers: this.getHeaders('order'),
            });
            return {
                success: true,
...
exports.default = new GHNService();
//# sourceMappingURL=GHNServiceImpl.js.map